...
export class Config {
    ...
    * @returns {Config}
    */
    static new(opacity, num_particles, distance, width, height) {
        const ret = wasm.config_new(opacity, num_particles, distance, width, height);
...
export class Particles {
    ...
    */
    static new(c) {
        ...
        const ret = wasm.particles_new(ptr0);
